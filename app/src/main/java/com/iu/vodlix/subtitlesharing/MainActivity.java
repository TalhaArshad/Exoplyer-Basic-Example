...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String userAgent = Util.getUserAgent(this, "PlaybackVideoFragment");
        ...
        MediaSource  videoSource =
                new HlsMediaSource.Factory(new DefaultDataSourceFactory(this, userAgent)).createMediaSource(Uri.parse(hls_url));
